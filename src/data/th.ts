...
export const th: ResumeData = {
  ...
  hero: {
    ...
    proof: [
      ...
      'วิศวกรรม <strong>{years}+</strong> ปี',
  ...
  synopsis: 'ผู้ก่อตั้งและซีอีโอของ Shadow Software LLC บริษัทวิศวกรรมเบื้องหลัง AmericanGunTrader.com และ DabDash.com ประสบการณ์สร้างซอฟต์แวร์กว่า {years}+ ปีให้กับธุรกิจค้าปลีก การจัดการสินทรัพย์ และความปลอดภัยระดับ Fortune ปัจจุบันทีมของเขาสร้างแพลตฟอร์มครบวงจรให้ลูกค้าทั่วโลก',
  synopsisHtml: 'ผู้ก่อตั้งและซีอีโอของ <a href="https://www.shadowsoftware.com" target="_blank" rel="noopener">Shadow Software LLC</a> บริษัทวิศวกรรมเบื้องหลัง <a href="/americanguntrader/">AmericanGunTrader.com™</a> และ <a href="/dabdash/">DabDash.com</a> ประสบการณ์สร้างซอฟต์แวร์กว่า {years}+ ปีให้กับธุรกิจค้าปลีก การจัดการสินทรัพย์ และความปลอดภัยระดับ Fortune ปัจจุบันทีมของเขาสร้างแพลตฟอร์มครบวงจรให้ลูกค้าทั่วโลก',
